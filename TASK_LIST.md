...
| 54 | 54.79.1–54.79.3 | Mobile: hide drag handle visually + central grip bar + hide Inspector button in diagram toolbar |
...
- [x] **57.2** **20px inset at Fit on mobile.** Implemented: fit-level scale/offset uses strict 20px padding target (`Vw - 40`, `Vh - 40`) against the active content bbox, centered by base offsets.
