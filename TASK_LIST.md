...
| 54 | 54.49–54.53, 54.50.1 | (Mobile-only) Diagram toolbar refinements: "+" visibility, no disappear, tap-to-expand, dead swipe-away removal, QA |
---
...
*Last updated: Feb 2026. Section 54: Mobile app (54.1–54.45 complete). 54.46–54.48: diagram toolbar collapsed = circular "+" only, no scroll, mobile orientation = desktop. 54.49–54.53 + 54.50.1: mobile diagram toolbar refinements and fix for disappearing at top (plan: docs/plans/2026-02-20-mobile-diagram-toolbar-disappearing-fix.md). Section 55 complete. Section 49: jobmaterial POST 400 (49.24). Section 48: Railway deployment. See TROUBLESHOOTING.md for displayed_amount error.*
